			<nav class="navbar navbar-default navbar-fixed-top" role="navigation"
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="{{ action('HomeController@showWelcome') }}">{{ Config::get('app.name') }}</a>
				</div>
				<!-- /.navbar-header -->
				...
				<ul class="nav navbar-top-links navbar-right">
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu dropdown-messages">
							...
							<li class="divider"></li>
							<li><a class="text-center" href="#"> <strong>Read All Messages</strong>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu dropdown-tasks">
							...
							<li class="divider"></li>
							<li><a class="text-center" href="#"> <strong>See All Tasks</strong>
									<i class="fa fa-angle-right"></i>
							</a></li>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu dropdown-alerts">
							...
							<li class="divider"></li>
							<li><a class="text-center" href="#"> <strong>See All Alerts</strong>
									<i class="fa fa-angle-right"></i>
							</a></li>
				...
				<div class="navbar-default navbar-static-side" role="navigation">
					<div class="sidebar-collapse">
						<ul class="nav" id="side-menu">
							...
							<li><a href="{{ action('HomeController@showWelcome') }}"><i class="fa fa-dashboard fa-fw"></i>
									Dashboard</a></li>
